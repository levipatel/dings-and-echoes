(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('automation-events'), require('@babel/runtime/helpers/classCallCheck'), require('@babel/runtime/helpers/slicedToArray'), require('@babel/runtime/helpers/typeof'), require('@babel/runtime/helpers/defineProperty'), require('@babel/runtime/helpers/createClass'), require('@babel/runtime/helpers/inherits'), require('@babel/runtime/helpers/possibleConstructorReturn'), require('@babel/runtime/helpers/getPrototypeOf'), require('@babel/runtime/regenerator'), require('@babel/runtime/helpers/asyncToGenerator'), require('@babel/runtime/helpers/assertThisInitialized'), require('@babel/runtime/helpers/toConsumableArray'), require('@babel/runtime/helpers/objectWithoutProperties')) :
    typeof define === 'function' && define.amd ? define(['exports', 'automation-events', '@babel/runtime/helpers/classCallCheck', '@babel/runtime/helpers/slicedToArray', '@babel/runtime/helpers/typeof', '@babel/runtime/helpers/defineProperty', '@babel/runtime/helpers/createClass', '@babel/runtime/helpers/inherits', '@babel/runtime/helpers/possibleConstructorReturn', '@babel/runtime/helpers/getPrototypeOf', '@babel/runtime/regenerator', '@babel/runtime/helpers/asyncToGenerator', '@babel/runtime/helpers/assertThisInitialized', '@babel/runtime/helpers/toConsumableArray', '@babel/runtime/helpers/objectWithoutProperties'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.standardizedAudioContext = {}, global.automationEvents, global._classCallCheck, global._slicedToArray, global._typeof, global._defineProperty, global._createClass, global._inherits, global._possibleConstructorReturn, global._getPrototypeOf, global._regeneratorRuntime, global._asyncToGenerator, global._assertThisInitialized, global._toConsumableArray, global._objectWithoutProperties));
}(this, (function (exports, automationEvents, _classCallCheck, _slicedToArray, _typeof, _defineProperty, _createClass, _inherits, _possibleConstructorReturn, _getPrototypeOf, _regeneratorRuntime, _asyncToGenerator, _assertThisInitialized, _toConsumableArray, _objectWithoutProperties) { 'use strict';
    ...
    var visitEachAudioNodeOnce = function visitEachAudioNodeOnce(cycles, visitor) {
      ...
      var _iterator = _createForOfIteratorHelper$1(cycles),
          _step;
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          var _iterator2 = _createForOfIteratorHelper$1(cycle),
              _step2;
      ...
      nativeAudioNode.disconnect = function (disconnect) {
        return function (destinationOrOutput, output, input) {
          ...
          if (destinationOrOutput === undefined) {
            ...
            var _iterator = _createForOfIteratorHelper$2(connections),
                _step;
          ...
          var _iterator2 = _createForOfIteratorHelper$2(connections),
              _step2;
    ...
    var deleteActiveInputConnection = function deleteActiveInputConnection(activeInputConnections, source, output) {
      var _iterator = _createForOfIteratorHelper$3(activeInputConnections),
          _step;
    ...
    var deleteAnyConnection = function deleteAnyConnection(source) {
      ...
      var _iterator2 = _createForOfIteratorHelper$3(audioNodeConnectionsOfSource.outputs),
          _step2;
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          if (isAudioNodeOutputConnection(outputConnection)) {
            deleteInputsOfAudioNode.apply(void 0, [source].concat(_toConsumableArray__default['default'](outputConnection)));
          } else {
            deleteInputsOfAudioParam.apply(void 0, [source].concat(_toConsumableArray__default['default'](outputConnection)));
          }
    ...
    var deleteConnectionAtOutput = function deleteConnectionAtOutput(source, output) {
      ...
      var _iterator3 = _createForOfIteratorHelper$3(audioNodeConnectionsOfSource.outputs),
          _step3;
      ...
      return /*#__PURE__*/function (_eventTargetConstruct) {
        ...
        _createClass__default['default'](AudioNode, [{
          ...
          value: function disconnect(destinationOrOutput, output, input) {
            ...
            var _iterator4 = _createForOfIteratorHelper$3(destinations),
                _step4;
    ...
    var createAudioParamRenderer = function createAudioParamRenderer(automationEventList) {
      return {
        replay: function replay(audioParam) {
          var _iterator = _createForOfIteratorHelper$4(automationEventList),
              _step;
    ...
    var sanitizedOptions = function sanitizedOptions(options) {
      return _objectSpread$3(_objectSpread$3({}, options), {}, {
    ...
    var createAudioWorkletNodeConstructor = function createAudioWorkletNodeConstructor(addUnrenderedAudioWorkletNode, audioNodeConstructor, createAudioParam, createAudioWorkletNodeRenderer, createNativeAudioWorkletNode, getNativeContext, isNativeOfflineAudioContext, nativeAudioWorkletNodeConstructor, wrapEventListener) {
      return /*#__PURE__*/function (_audioNodeConstructor) {
        ...
        function AudioWorkletNode(context, name) {
          ...
          var nativeContext = getNativeContext(context);
          var isOffline = isNativeOfflineAudioContext(nativeContext);
          var mergedOptions = sanitizedOptions(_objectSpread$3(_objectSpread$3({}, DEFAULT_OPTIONS$3), options));
          var nodeNameToProcessorConstructorMap = NODE_NAME_TO_PROCESSOR_CONSTRUCTOR_MAPS.get(nativeContext);
    ...
    var processBuffer = /*#__PURE__*/function () {
      var _ref = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee(proxy, renderedBuffer, nativeOfflineAudioContext, options, processorConstructor, exposeCurrentFrameAndCurrentTime) {
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                          ...
                          while (1) {
                            switch (_context3.prev = _context3.next) {
                              ...
                              case 6:
                                ...
                                _iterator = _createForOfIteratorHelper$5(constantSourceNodes.entries());
                  ...
                  case 39:
                    ...
                    _iterator2 = _createForOfIteratorHelper$5(proxy.parameters.entries());
                    _context4.prev = 41;
                  ...
                  case 59:
                    _iterator3 = _createForOfIteratorHelper$5(proxy.parameters.entries());
                    _context4.prev = 60;
    ...
    var createBiquadFilterNodeConstructor = function createBiquadFilterNodeConstructor(audioNodeConstructor, createAudioParam, createBiquadFilterNodeRenderer, createInvalidAccessError, createNativeBiquadFilterNode, getNativeContext, isNativeOfflineAudioContext) {
      return /*#__PURE__*/function (_audioNodeConstructor) {
        ...
        function BiquadFilterNode(context) {
          ...
          _this = _super.call(this, context, false, nativeBiquadFilterNode, biquadFilterNodeRenderer); // Bug #80: Edge & Safari do not export the correct values for maxValue and minValue.
          ...
          _this._detune = createAudioParam(_assertThisInitialized__default['default'](_this), isOffline, nativeBiquadFilterNode.detune, 1200 * Math.log2(MOST_POSITIVE_SINGLE_FLOAT), -1200 * Math.log2(MOST_POSITIVE_SINGLE_FLOAT));
          /*
    ...
    var sanitizedOptions$1 = function sanitizedOptions(options) {
      return _objectSpread$8(_objectSpread$8({}, options), {}, {
    ...
    var createChannelSplitterNodeConstructor = function createChannelSplitterNodeConstructor(audioNodeConstructor, createChannelSplitterNodeRenderer, createNativeChannelSplitterNode, getNativeContext, isNativeOfflineAudioContext) {
      return /*#__PURE__*/function (_audioNodeConstructor) {
        ...
        function ChannelSplitterNode(context) {
          ...
          var nativeContext = getNativeContext(context);
          var mergedOptions = sanitizedOptions$1(_objectSpread$8(_objectSpread$8({}, DEFAULT_OPTIONS$6), options));
      ...
      return function (audioNode, count) {
        ...
        if (cycleCounter === count) {
          ...
          if (!isOffline && isActiveAudioNode(audioNode)) {
            ...
            var _iterator = _createForOfIteratorHelper$6(outputs),
                _step;
    ...
    var createDelayNodeConstructor = function createDelayNodeConstructor(audioNodeConstructor, createAudioParam, createDelayNodeRenderer, createNativeDelayNode, getNativeContext, isNativeOfflineAudioContext) {
      return /*#__PURE__*/function (_audioNodeConstructor) {
        ...
        function DelayNode(context) {
          ...
          _this._delayTime = createAudioParam(_assertThisInitialized__default['default'](_this), isOffline, nativeDelayNode.delayTime, mergedOptions.maxDelayTime, 0);
          return _this;
        }
    ...
    var createDynamicsCompressorNodeConstructor = function createDynamicsCompressorNodeConstructor(audioNodeConstructor, createAudioParam, createDynamicsCompressorNodeRenderer, createNativeDynamicsCompressorNode, createNotSupportedError, getNativeContext, isNativeOfflineAudioContext) {
      return /*#__PURE__*/function (_audioNodeConstructor) {
        ...
        function DynamicsCompressorNode(context) {
          ...
          _this._attack = createAudioParam(_assertThisInitialized__default['default'](_this), isOffline, nativeDynamicsCompressorNode.attack, 1, 0);
          _this._knee = createAudioParam(_assertThisInitialized__default['default'](_this), isOffline, nativeDynamicsCompressorNode.knee, 40, 0);
          _this._nativeDynamicsCompressorNode = nativeDynamicsCompressorNode;
          _this._ratio = createAudioParam(_assertThisInitialized__default['default'](_this), isOffline, nativeDynamicsCompressorNode.ratio, 20, 1);
          _this._release = createAudioParam(_assertThisInitialized__default['default'](_this), isOffline, nativeDynamicsCompressorNode.release, 1, 0);
          _this._threshold = createAudioParam(_assertThisInitialized__default['default'](_this), isOffline, nativeDynamicsCompressorNode.threshold, 0, -100);
          return _this;
        }
    ...
    var createGainNodeConstructor = function createGainNodeConstructor(audioNodeConstructor, createAudioParam, createGainNodeRenderer, createNativeGainNode, getNativeContext, isNativeOfflineAudioContext) {
      return /*#__PURE__*/function (_audioNodeConstructor) {
        ...
        function GainNode(context) {
          ...
          _this = _super.call(this, context, false, nativeGainNode, gainNodeRenderer); // Bug #74: Edge & Safari do not export the correct values for maxValue and minValue.
        ...
        return function (audioNode, count) {
          ...
          if (cycleCounter === undefined) {
            if (!isOffline && isActiveAudioNode(audioNode)) {
              ...
              var _iterator = _createForOfIteratorHelper$7(outputs),
                  _step;
    ...
    var createMediaElementAudioSourceNodeConstructor = function createMediaElementAudioSourceNodeConstructor(audioNodeConstructor, createNativeMediaElementAudioSourceNode, getNativeContext, isNativeOfflineAudioContext) {
      return /*#__PURE__*/function (_audioNodeConstructor) {
        ...
        function MediaElementAudioSourceNode(context, options) {
          ...
          _this = _super.call(this, context, true, nativeMediaElementAudioSourceNode, null); // Bug #63: Edge does not expose the mediaElement yet.
    ...
    var createMediaStreamAudioDestinationNodeConstructor = function createMediaStreamAudioDestinationNodeConstructor(audioNodeConstructor, createNativeMediaStreamAudioDestinationNode, getNativeContext, isNativeOfflineAudioContext) {
      return /*#__PURE__*/function (_audioNodeConstructor) {
        ...
        function MediaStreamAudioDestinationNode(context) {
          ...
          var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : DEFAULT_OPTIONS$d;
    ...
    var createMinimalBaseAudioContextConstructor = function createMinimalBaseAudioContextConstructor(audioDestinationNodeConstructor, createAudioListener, eventTargetConstructor, isNativeOfflineAudioContext, unrenderedAudioWorkletNodeStore, wrapEventListener) {
      return /*#__PURE__*/function (_eventTargetConstruct) {
        ...
        function MinimalBaseAudioContext(_nativeContext, numberOfChannels) {
          ...
          _this._nativeContext = _nativeContext;
          CONTEXT_STORE.set(_assertThisInitialized__default['default'](_this), _nativeContext); // Bug #93: Edge will set the sampleRate of an AudioContext to zero when it is closed.
        ...
        nativeAudioNode.disconnect = function (disconnect) {
          return function (destinationOrOutput, output, input) {
            ...
            if (destinationOrOutput === undefined) {
              ...
              var _iterator = _createForOfIteratorHelper$8(connections),
                  _step;
              ...
              var _iterator2 = _createForOfIteratorHelper$8(connections),
                  _step2;
                  ...
                  if (unpatchedEventListener !== null) {
                    ...
                    if (patchedEventListener !== undefined) {
                      ...
                      args[1] = function (event) {
                        unpatchedEventListener(new ErrorEvent(args[0], _objectSpread$h(_objectSpread$h({}, event), {}, {
                          error: new Error()
                        })));
                      };
    ...
    var createNativeAudioWorkletNodeFakerFactory = function createNativeAudioWorkletNodeFakerFactory(auxiliaryGainNodeStore, connectMultipleOutputs, createIndexSizeError, createInvalidStateError, createNativeChannelMergerNode, createNativeChannelSplitterNode, createNativeConstantSourceNode, createNativeGainNode, createNativeScriptProcessorNode, createNotSupportedError, disconnectMultipleOutputs, exposeCurrentFrameAndCurrentTime, monitorConnections) {
      return function (nativeContext, baseLatency, processorConstructor, options) {
        ...
        if (processorConstructor.parameterDescriptors !== undefined) {
          var _iterator = _createForOfIteratorHelper$9(processorConstructor.parameterDescriptors),
              _step;
        ...
        var nativeAudioWorkletNodeFaker = {
          ...
          set channelInterpretation(value) {
            var _iterator2 = _createForOfIteratorHelper$9(gainNodes),
                _step2;
    ...
    var createOscillatorNodeConstructor = function createOscillatorNodeConstructor(audioNodeConstructor, createAudioParam, createInvalidStateError, createNativeOscillatorNode, createOscillatorNodeRenderer, getNativeContext, isNativeOfflineAudioContext, wrapEventListener) {
      return /*#__PURE__*/function (_audioNodeConstructor) {
        ...
        function OscillatorNode(context) {
          ...
          _this._detune = createAudioParam(_assertThisInitialized__default['default'](_this), isOffline, nativeOscillatorNode.detune, 153600, -153600); // Bug #76: Edge & Safari do not export the correct values for maxValue and minValue.
    ...
    var createPannerNodeConstructor = function createPannerNodeConstructor(audioNodeConstructor, createAudioParam, createNativePannerNode, createPannerNodeRenderer, getNativeContext, isNativeOfflineAudioContext) {
      return /*#__PURE__*/function (_audioNodeConstructor) {
        ...
        function PannerNode(context) {
          ...
          _this._positionZ = createAudioParam(_assertThisInitialized__default['default'](_this), isOffline, nativePannerNode.positionZ, MOST_POSITIVE_SINGLE_FLOAT, MOST_NEGATIVE_SINGLE_FLOAT);
          return _this;
        }
    ...
    var createPeriodicWaveConstructor = function createPeriodicWaveConstructor(createNativePeriodicWave, getNativeContext, periodicWaveStore) {
      return /*#__PURE__*/function () {
        function PeriodicWave(context, options) {
          ...
          var mergedOptions = _objectSpread$r(_objectSpread$r({}, DEFAULT_OPTIONS$i), options);
    ...
    var createStereoPannerNodeConstructor = function createStereoPannerNodeConstructor(audioNodeConstructor, createAudioParam, createNativeStereoPannerNode, createStereoPannerNodeRenderer, getNativeContext, isNativeOfflineAudioContext) {
      return /*#__PURE__*/function (_audioNodeConstructor) {
        ...
        function StereoPannerNode(context) {
          ...
          _this = _super.call(this, context, false, nativeStereoPannerNode, stereoPannerNodeRenderer); // Bug #106: Edge does not export a maxValue and minValue property.

          _this._pan = createAudioParam(_assertThisInitialized__default['default'](_this), isOffline, nativeStereoPannerNode.pan, 1, -1);
          return _this;
        }
    ...
    var createNativeConstantSourceNode = createNativeConstantSourceNodeFactory(addSilentConnection, cacheTestResult, createNativeAudioNode, createNativeConstantSourceNodeFaker, testAudioScheduledSourceNodeStartMethodNegativeParametersSupport, testAudioScheduledSourceNodeStopMethodNegativeParametersSupport);
    ...
    var createNativeOscillatorNode = createNativeOscillatorNodeFactory(addSilentConnection, cacheTestResult, createNativeAudioNode, testAudioScheduledSourceNodeStartMethodNegativeParametersSupport, testAudioScheduledSourceNodeStopMethodConsecutiveCallsSupport, testAudioScheduledSourceNodeStopMethodNegativeParametersSupport, wrapAudioScheduledSourceNodeStopMethodConsecutiveCalls);
    ...
    var addAudioWorkletModule = isSecureContext ? createAddAudioWorkletModule(createNotSupportedError, createEvaluateSource(window$1), exposeCurrentFrameAndCurrentTime, createFetchSource(createAbortError), getBackupNativeContext, getNativeContext, new WeakMap(), new WeakMap(), // @todo window is guaranteed to be defined because isSecureContext checks that as well.
    window$1) : undefined;
    ...
    var createNativeMediaStreamAudioDestinationNode = createNativeMediaStreamAudioDestinationNodeFactory(createNativeAudioNode, createNotSupportedError);
    ...
    var createNativeMediaStreamTrackAudioSourceNode = createNativeMediaStreamTrackAudioSourceNodeFactory(createInvalidStateError, createNativeAudioNode, isNativeOfflineAudioContext);
    ...
    var createNativeAudioWorkletNode = createNativeAudioWorkletNodeFactory(createInvalidStateError, createNativeAudioNode, createNativeAudioWorkletNodeFaker, createNativeGainNode, createNotSupportedError, monitorConnections);
